package com.sparta.springpostwork01.filter;

import com.sparta.springpostwork01.jwt.HeaderTokenExtractor;
import com.sparta.springpostwork01.jwt.JwtPreProcessingToken;
...
public class JwtAuthFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(
        ...
        if (tokenPayload == null) {
            response.sendRedirect("/user/loginView"); //토큰없음
            return null;
        }

        JwtPreProcessingToken jwtToken = new JwtPreProcessingToken( //토큰 있음
